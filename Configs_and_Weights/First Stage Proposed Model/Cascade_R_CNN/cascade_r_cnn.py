...
test_evaluator = dict(
    ...
    metric='bbox',
    format_only=False,
    outfile_prefix='/home/matheus_levy/workspace/RPN_YOLO_Center_Retina/predicts_bbox_cascade_swin_val.json',
    backend_args=None,
    )
...
resume = False
launcher = 'none'
work_dir = '/home/matheus_levy/workspace/RPN_YOLO_Center_Retina/Cascade_R_CNN/work_dir'